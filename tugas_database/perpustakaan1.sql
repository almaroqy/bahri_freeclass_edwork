...
(1, 'alma', 'tutorial lambada', 5000, 300, 'adult', 'I-20', 2016, '', 'dddddddddddddddddsfsscsdcscsdcscsc'),
...
(600233, 'bahr', 'mecha on the rood', 200, 10, 'triler', 'I-7', 2000, '', 'CSDFSFSFSDSDFsfsfsfsfsf'),
(600234, 'husa', 'computer is black', 100, 20, 'SCI-FI', 'G-30', 1946, '', 'fsfsfsfwefcsggdfasfs'),
(600235, 'smgt', 'black on the bottom', 20, 3, 'isekai', 'S-69', 1922, '', 'ssffsfsdfsfsdfsf'),
(600236, 'sulo', 'hole in a cupboard', 900, 300, 'fantasy', 'S-78', 1922, '', 'ssffssdfsfdfsdfsfsdfsf');
...
--
ALTER TABLE `buku`
  MODIFY `id_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=600237;
